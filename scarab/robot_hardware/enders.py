...
class FenixEnders():
    ...
    def __init__(self):
        ...
        GPIO.setup(self.MIDDLE_LEFT, GPIO.IN, pull_up_down=GPIO.PUD_UP)
        GPIO.add_event_detect(self.MIDDLE_LEFT, GPIO.BOTH, callback=button_changed_middle_left, bouncetime=10)

        GPIO.setup(self.MIDDLE_RIGHT, GPIO.IN, pull_up_down=GPIO.PUD_UP)
        GPIO.add_event_detect(self.MIDDLE_RIGHT, GPIO.BOTH, callback=button_changed_middle_right, bouncetime=10)
