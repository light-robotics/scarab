...
class RobotDualSense(DualSense):
    """
    To execute neopixel commands run scarab/run/neopixel_commands_reader.py before running this
    To execute servo commands run scarab/core/movement_processor.py AFTER running this
    """
    def __init__(self):
    ...
    def on_right_arrow_press(self):
        ...
        if self.feedback_mode_on:
           ...
           self.command_writer.write_command('right_hook', 0)
        elif self.mode == FenixModes.WALKING:
    ...
    def on_left_arrow_press(self):
        ...
        if self.feedback_mode_on:
           ...
           self.command_writer.write_command('left_hook', 0)
        elif self.mode == FenixModes.RUN:
